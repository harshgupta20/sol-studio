...
import { structuredCall, textCall } from './anthropicClient';
...
export class AnthropicProvider implements AIProvider {
  ...
  async analyzeRepository(
    ...
    return structuredCall<RepositoryAnalysis>({
      ...
      tool: {
        ...
        description: 'Submit your structured repository analysis.',
  ...
  async summarizeChanges(
    ...
    return structuredCall<ChangeSummary>({
      ...
      tool: {
        name: 'submit_summary',
        description: 'Submit the commit message and PR description.',
